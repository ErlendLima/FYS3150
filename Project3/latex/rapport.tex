...
The initial values of the solar system bodies are fetched from NASA
(see \cite{NASA}). Mer her perhaps?
\subsection{Earth-Sun system - Comparison of Forward Euler and Velocity-Verlet}
