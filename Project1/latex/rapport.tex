...
The general algorithm and the LU-decomposition converged upwards while the
special method converged downwards. Figure~\ref{fig:general} shows a plot where
the general method is used for different number of points \(n\).
...
figure~\ref{fig:error}, where it is plotted against stepsize.
