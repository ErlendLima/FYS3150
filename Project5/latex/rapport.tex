...
here for two reasons, first of all the boundaries are held constant and will hever have errors,
and secondly, the error calculation would include division by zero.
\begin{figure}[ht]
  \centering
  \includegraphics[width=\columnwidth]{figures/relative_error_in_position.eps}
  \caption{\label{fig:posrelerr} Error for the different node positions across the domain.}
\end{figure}
\begin{figure}[ht]
  \centering
  \includegraphics[width=\columnwidth]{figures/relative_error_in_time.eps}
  \caption{\label{fig:timerelerr} Error developement with time.}
\end{figure}
